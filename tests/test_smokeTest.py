...
class TestSmokeTest():
  ...
  def test_smokeTest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Anelisa")
    self.driver.find_element(By.NAME, "lname").send_keys("Ozolin")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Anelisa")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("uodhcfoaudjna")
